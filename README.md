...
from patients who underwent major colorectal surgery to identify the features that are most predictive of LOS and build a model that predicts LOS within 2 days for 88% of patients. To do so, I took the following steps:
